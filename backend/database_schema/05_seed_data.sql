...
(2, 4, 'Offer Aspirin if appropriate. If the person is conscious, not allergic to aspirin, and has no history of severe bleeding, give them one adult aspirin (325 mg) or 2 to 4 low-dose aspirins (81 mg each). Tell them to chew it, not swallow it whole.', 
       'အခြေအနေအလိုက် အက်စပရင် (Aspirin) ဆေးပြား တိုက်ကျွေးပါ။ လူနာသည် သတိရနေပြီး၊ ဆေးနှင့် ဓာတ်မတည့်ခြင်းမရှိ၊ သွေးထွက်လွန်ဖူးသည့် ရာဇဝင်မရှိပါက လူကြီးသောက် အက်စပရင် ၁ ပြား (325 mg) သို့မဟုတ် အနိမ့်စား (81 mg) ကို ၂ ပြားမှ ၄ ပြားအထိ တိုက်နိုင်ပါသည်။ မျိုမချခိုင်းဘဲ ဝါးစားခိုင်းပါ။'),
...
(3, 3, 'Do not put anything in their mouth. Do not, under any circumstances, force objects between the patient''s teeth. Forcing an object between their teeth can cause severe dental or airway injury.', 
...
(4, 2, 'Position the person safely. Keep the person lying flat on their back. If possible and there are no signs of injury, elevate their legs about 12 inches to help restore blood flow to the heart and brain.', 
       'လူနာကို ဘေးကင်းသောအနေအထားဖြင့် ထားပါ။ လူနာကို ပက်လက်လှန်အနေအထားဖြင့် ပြားပြားလေး သိပ်ထားပါ။ အကယ်၍ ထိခိုက်ဒဏ်ရာရထားသည့် လက္ခဏာမရှိပါက နှလုံးနှင့် ဦးနှောက်ဆီသို့ သွေးစီးဆင်းမှု ပြန်လည်ကောင်းမွန်စေရန်  ခြေထောက်ကို ၁ ပေခန့် (၁၂ လက်မ) မြှင့်ထားပေးပါ။'),
(4, 3, 'Loosen tight clothing. Undo tight collars, ties, belts, or waistbands to ease breathing and circulation.', 
       'ကျပ်နေသောအဝတ်အစားများကို လျှော့ပေးပါ။ အသက်ရှူရလွယ်ကူစေရန်နှင့် သွေးလှည့်ပတ်မှုကောင်းစေရန် ကျပ်နေသော ကော်လာများ၊ လည်စည်း၊ ခါးပတ်နှင့် ဘောင်းဘီခါးစည်းများကို ဖြေလျှော့ပေးပါ။'),
...
-- ======================================================
INSERT INTO first_aid_steps (category_id, step_number, instruction_en, instruction_mm) VALUES
(5, 1, 'Apply direct pressure to the wound. Place a clean dressing directly over the wound and press firmly with both hands.', 
...
(5, 2, 'Maintain constant pressure. Do not lift the dressing to check if bleeding has stopped. If blood seeps through, place another cloth right on top and keep pressing.', 
       'မလွှတ်တမ်း ဆက်တိုက် ဖိထားပါ။ သွေးတိတ်၊ မတိတ် စစ်ဆေးရန် ပတ်တီးကို မကြွပါနှင့်။ ကြွလိုက်ပါက သွေးခဲများကို ပျက်စီးစေပြီး သွေးပြန်ထွက်လာနိုင်သည်။ သွေးစိုရွှဲထွက်လာပါက ပထမအဝတ်ပေါ်ကနေ နောက်ထပ်အဝတ်တစ်ထပ် ထပ်ဆင့်ပြီး ဆက်ဖိထားပါ။'),
...
(6, 3, 'Use an Epinephrine Auto-Injector (EpiPen). If available, press it firmly directly onto the outer thigh muscle(through clothing if necessary) and hold it in place for 3 seconds.', 
...
(9, 4, 'Give 5 abdominal thrusts (Heimlich Maneuver). If the object is still stuck, stand behind the person, wrap your arms around their waist, make a fist just above the navel, and thrust inward and upward 5 times.', 
       'ဝမ်းဗိုက်ကို ၅ ကြိမ် ဆောင့်တွန်းပေးပါ။ အဝတ်/အရာဝတ္ထု ညပ်နေဆဲဖြစ်ပါက လူနာ၏နောက်တွင်ရပ်ပြီး လက်များဖြင့် ခါးကို ဝိုင်းပွေ့ကာ ချက်အထက်နားတွင် လက်သီးဆုပ်တစ်ခုပြုလုပ်၍ အတွင်းဘက်နှင့် အပေါ်ဘက်သို့ ၅ ကြိမ် တွန်းကန်ပါ။(Heimlich Maneuver)'),
